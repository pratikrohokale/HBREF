...
public class AuthenticationDAOImpl implements AuthenticationDAO {
 private static final String CALL_PROCEDURE="{call P_AUTHENTICATION(?,?,?)}";
	...
	public String authenticate(String user, String pass) {
		...
		result=ses.doReturningWork(new AuthReturningWork(user,pass));
	...
	private class AuthReturningWork implements ReturningWork<String>{
          private String user,pass;
		public AuthReturningWork(String user,String pass) {
			this.user=user;
			this.pass=pass;
		}
